...
describe 'EventTagUtils' do
  ...
  describe '.get_numeric_value' do
    it 'should return nil if argument is not a Hash' do
      expect(Optimizely::Helpers::EventTagUtils.get_numeric_value(nil)).to be_nil
      expect(Optimizely::Helpers::EventTagUtils.get_numeric_value(0.5)).to be_nil
      expect(Optimizely::Helpers::EventTagUtils.get_numeric_value(65536)).to be_nil
      expect(Optimizely::Helpers::EventTagUtils.get_numeric_value(9223372036854775807)).to be_nil
      expect(Optimizely::Helpers::EventTagUtils.get_numeric_value('65536')).to be_nil
      expect(Optimizely::Helpers::EventTagUtils.get_numeric_value(false)).to be_nil
      expect(Optimizely::Helpers::EventTagUtils.get_numeric_value([])).to be_nil
    end
    it 'should return nil if event tags does not contain the value' do
      event_tags = {
        'non-value' => 5432,
      }
      expect(Optimizely::Helpers::EventTagUtils.get_numeric_value(event_tags)).to be_nil
    end
    ...
    it 'should return correct value if event tags contains the value with a numeric string value' do
      ...
      expect(Optimizely::Helpers::EventTagUtils.get_numeric_value(event_tags)).to eq(65536)
    end
    ...
    it 'should return correct value if event tags contains the value with a float value' do
      ...
      expect(Optimizely::Helpers::EventTagUtils.get_numeric_value(event_tags)).to eq(0.5)
    end
    ...
    it 'should return correct value if event tags contains the value with a long value' do
      ...
      expect(Optimizely::Helpers::EventTagUtils.get_numeric_value(event_tags)).to eq(9223372036854775807)
    end
  end
