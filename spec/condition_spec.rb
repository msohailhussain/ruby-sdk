...
#       'city' => 'san francisco'
#     }
#     @condition_evaluator = Optimizely::ConditionTreeEvaluator.new(user_attributes)
#   end
#
...
#       condition_evaluator = Optimizely::ConditionTreeEvaluator.new({})
...
#       condition_evaluator = Optimizely::ConditionTreeEvaluator.new('input_value' => nil)
#       expect(condition_evaluator.evaluate(@exists_conditions)).to be false
#     end
#
#     it 'should return true if the user-provided value is a string' do
#       condition_evaluator = Optimizely::ConditionTreeEvaluator.new('input_value' => 'test')
...
#       condition_evaluator = Optimizely::ConditionTreeEvaluator.new('input_value' => 10)
#       expect(condition_evaluator.evaluate(@exists_conditions)).to be true
#     end
#
#     it 'should return true if the user-provided value is a boolean' do
#       condition_evaluator = Optimizely::ConditionTreeEvaluator.new('input_value' => false)
#       expect(condition_evaluator.evaluate(@exists_conditions)).to be true
#     end
#   end
#
...
#         condition_evaluator = Optimizely::ConditionTreeEvaluator.new('location' => 'san francisco')
...
#         condition_evaluator = Optimizely::ConditionTreeEvaluator.new('location' => 'new york')
...
#         condition_evaluator = Optimizely::ConditionTreeEvaluator.new('location' => false)
...
#         condition_evaluator = Optimizely::ConditionTreeEvaluator.new('location' => {})
#         expect(condition_evaluator.evaluate(@exact_string_conditions)).to eq(nil)
#       end
#     end
#
...
#
#       it 'should return true if the user-provided value is equal to the condition value' do
#         condition_evaluator = Optimizely::ConditionTreeEvaluator.new('sum' => 100)
#         expect(condition_evaluator.evaluate(@exact_number_conditions)).to be true
#       end
#
#       it 'should return false if the user-provided value is not equal to the condition value' do
#         condition_evaluator = Optimizely::ConditionTreeEvaluator.new('sum' => 101)
#         expect(condition_evaluator.evaluate(@exact_number_conditions)).to be false
#       end
#
#       it 'should return nil if the user-provided value is of a different type than the condition value' do
#         condition_evaluator = Optimizely::ConditionTreeEvaluator.new('sum' => false)
#         expect(condition_evaluator.evaluate(@exact_number_conditions)).to eq(nil)
#       end
#
#       it 'should return nil if there is no user-provided value' do
#         condition_evaluator = Optimizely::ConditionTreeEvaluator.new('sum' => {})
#         expect(condition_evaluator.evaluate(@exact_number_conditions)).to eq(nil)
#       end
#     end
#
...
#
#       it 'should return true if the user-provided value is equal to the condition value' do
#         condition_evaluator = Optimizely::ConditionTreeEvaluator.new('boolean' => false)
#         expect(condition_evaluator.evaluate(@exact_boolean_conditions)).to be true
#       end
#
#       it 'should return false if the user-provided value is not equal to the condition value' do
#         condition_evaluator = Optimizely::ConditionTreeEvaluator.new('boolean' => true)
#         expect(condition_evaluator.evaluate(@exact_boolean_conditions)).to be false
#       end
#
#       it 'should return nil if the user-provided value is of a different type than the condition value' do
#         condition_evaluator = Optimizely::ConditionTreeEvaluator.new('boolean' => 10)
#         expect(condition_evaluator.evaluate(@exact_boolean_conditions)).to eq(nil)
#       end
#
#       it 'should return nil if there is no user-provided value' do
#         condition_evaluator = Optimizely::ConditionTreeEvaluator.new('boolean' => {})
#         expect(condition_evaluator.evaluate(@exact_boolean_conditions)).to eq(nil)
#       end
#     end
#   end
...
#       condition_evaluator = Optimizely::ConditionTreeEvaluator.new('text' => 'This is a test message!')
...
#       condition_evaluator = Optimizely::ConditionTreeEvaluator.new('text' => 'Not found!')
...
#       condition_evaluator = Optimizely::ConditionTreeEvaluator.new('text' => 10)
#       expect(condition_evaluator.evaluate(@substring_conditions)).to eq(nil)
#     end
#
#     it 'should return nil if there is no user-provided value' do
#       condition_evaluator = Optimizely::ConditionTreeEvaluator.new('text' => {})
#       expect(condition_evaluator.evaluate(@substring_conditions)).to eq(nil)
#     end
#   end
#
...
#       condition_evaluator = Optimizely::ConditionTreeEvaluator.new('input_value' => 12)
...
#       condition_evaluator = Optimizely::ConditionTreeEvaluator.new('input_value' => 8)
